...
export const projects: Project[] = [
  ...
  },
  {
    ...
    kind: "fullstack",
    cardSize: "wide",
    tag: "Digital Product Platform",
    color: "from-violet-500/50 to-cyan-500/30",
    desc: "A digital product platform and web experience for selling, managing, and securely delivering e-book content.",
    role: "Lead Full Stack Developer & UI/UX Designer",
    tools: ["React", "Tailwind CSS", "Supabase", "Vercel"],
    year: "2025",
    client: "Cosmic Remedies by Sia",
    overview:
      "Cosmic Remedies by Sia is a digital product platform designed to present, sell, and deliver e-book content through a calm, responsive, and secure web experience. The project focused on translating the brand's spiritual and storytelling-driven identity into a usable product system with customer accounts, protected content access, and an admin-ready structure.",
    goals: [
      "Create a calm and intuitive digital experience for discovering and purchasing e-book content.",
      "Design a responsive interface that supports both product storytelling and clear user actions.",
      "Build a secure content delivery flow for purchased PDF materials.",
      "Provide a scalable structure for customer accounts, admin management, and future product expansion.",
    ],
    impact: [
    ...
    focusAreas: [
      {
        ...
        text: "Structured the platform around product discovery, reading intent, purchase flow, and post-purchase access.",
      },
      {
        title: "Customer Accounts",
        text: "Planned account-based access so users could view purchased materials instead of relying on public download links.",
      },
      {
        title: "Protected Content Delivery",
        text: "Designed the flow for secure PDF access using restricted file handling and temporary access links.",
      },
      {
        title: "Admin Management",
        text: "Outlined admin-side controls for managing digital products, customer purchases, and content availability.",
      },
      {
        title: "Responsive Interface",
        text: "Refined layouts, spacing, and readability across desktop and mobile screens for a smoother browsing experience.",
      },
      {
        title: "Brand Atmosphere",
        text: "Balanced cosmic, spiritual, and wellness-inspired visuals with a clean interface that remains easy to use.",
      },
    ],
    process: [
      {
        title: "Discover",
        text: "Studied the brand mood, target audience, and digital product goals to define the platform direction.",
      },
      {
        title: "Structure",
        text: "Mapped the content hierarchy, customer journey, product flow, and account-based access model.",
      },
      {
        title: "Craft",
        text: "Created responsive screens, reusable UI patterns, and a visual system that supported the brand's calm identity.",
      },
      {
        title: "Build",
        text: "Developed the web experience with reusable components, authentication-ready flows, and secure content delivery planning.",
      },
    ],
    challenges: [
      {
        ...
        challenge:
          "Digital products needed to be accessible only after purchase without exposing permanent public PDF links.",
        solution:
          "Planned protected file access through customer accounts, temporary signed URLs, and purchase-based content visibility.",
      },
      {
        title: "Brand Mood vs. Usability",
        challenge:
          "The interface needed to feel spiritual and immersive while still remaining clear for browsing, purchasing, and reading.",
        solution:
          "Used a restrained visual system, readable layouts, and focused interaction patterns to keep the experience calm but functional.",
      },
      {
        title: "Scalable Product Structure",
        challenge:
          "The platform needed to support future e-book releases without rebuilding the entire experience.",
        solution:
          "Organized the interface around reusable sections, product records, account views, and admin-ready management flows.",
      },
    ],
    outcome:
      "The project resulted in a responsive digital product platform that brings Cosmic Remedies by Sia into a more structured online experience. It supports product storytelling, customer accounts, secure content access, and a scalable foundation for future e-book releases.",
    gallery: [
      {
        color: "from-violet-500/50 to-cyan-500/30",
        label: "Landing Experience",
        ratio: "wide",
        note: "Hero and storytelling sections introducing the Cosmic Remedies by Sia brand and digital products.",
      },
      {
        color: "from-cyan-500/40 to-indigo-500/30",
        label: "Product Flow",
        ratio: "square",
        note: "Product browsing, purchase intent, and account-based access flow for e-book content.",
      },
      {
        color: "from-indigo-500/40 to-purple-500/30",
        label: "Protected Access",
        ratio: "square",
        note: "Customer library concept for viewing purchased materials through secure PDF delivery.",
      },
    ],
