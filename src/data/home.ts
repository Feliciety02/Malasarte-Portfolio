...
export const tools: readonly {
  ...
  { name: "Photoshop", slug: "adobephotoshop", color: "31A8FF", category: "tools" },
  { name: "Illustrator", slug: "adobeillustrator", color: "FF9A00", category: "tools" },
  { name: "Notion", slug: "notion", color: "000000", category: "tools" },
  { name: "Discord", slug: "discord", color: "5865F2", category: "tools" },
];
