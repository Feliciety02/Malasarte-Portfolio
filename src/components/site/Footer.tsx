...
export function Footer() {
  ...
  return (
    <footer className="relative mt-32 border-t border-border/60 px-6 py-16">
      ...
      <div className="mx-auto mt-12 flex max-w-7xl items-center justify-between border-t border-border/60 pt-6 text-xs text-muted-foreground">
        <p>© {new Date().getFullYear()} Fe Anne Malasarte. Designed with care.</p>
