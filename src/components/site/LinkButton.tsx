  ...
  return (
    <Link
      ...
      className={cn(
        ...
        variant === "primary" &&
          "rounded-full bg-gradient-hero px-5 py-3 text-primary-foreground shadow-glow hover:scale-105 md:px-7 md:py-3.5",
        variant === "glass" &&
          "rounded-full glass px-5 py-3 hover:bg-white/10 md:px-7 md:py-3.5",
